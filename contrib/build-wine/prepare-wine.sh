...
mkdir -p /tmp/denariium-build

cd /tmp/denariium-build
...
KEYRING_PYTHON_DEV="keyring-denariium-build-python-dev.gpg"
...
# Upgrade setuptools (so Denariium can be installed later)
