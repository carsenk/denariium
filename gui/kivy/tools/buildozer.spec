...
presplash.filename = %(source.dir)s/icons/denariium_presplash.png

# (str) Icon of the application
icon.filename = %(source.dir)s/icons/denariium_launcher.png
...
android.add_activities = org.denariium.qr.SimpleScannerActivity
...
android.manifest.intent_filters = gui/kivy/tools/denarius_intent.xml
